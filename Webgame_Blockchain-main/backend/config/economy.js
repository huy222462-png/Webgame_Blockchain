...
const withdrawMethodSignature = process.env.BOMDOG_WITHDRAW_METHOD || 'transfer(address,uint256)';
...
try {
  ...
  console.warn('Invalid BOMDOG_CONTRACT_ABI JSON. Falling back to default ERC20 signatures.');
  abi = [
    'function transfer(address to, uint256 amount) external returns (bool)',
    'function balanceOf(address account) external view returns (uint256)',
    'function decimals() external view returns (uint8)'
